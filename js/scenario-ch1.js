  ...
  scenes: {
    ...
    ch1_scene2: {
      ...
      content: [
        ...
        { type: 'narration', text: '寝ぼけた頭で通知をタップする。\n記事を読んで、血の気が引いた。' },
        {
          type: 'notification',
          title: 'SNSトレンド',
          text: '「元社員の野口が事件現場付近で目撃」との情報が拡散中',
        },
        {
          type: 'evidence',
          id: 'noguchi_sighting',
          name: '野口の目撃情報',
          description: '解雇された元社員・野口健二が事件当夜に田中のマンション付近で目撃されたという情報。',
        },
    ...
    ch1_scene5_investigate: {
      ...
      content: [
        ...
        { type: 'narration', text: 'さらに遡ると、\n田中のDMに見慣れない女性のアカウント。\n親しげなやり取りの痕跡がある。' },
        { type: 'narration', text: '最後のメッセージは\n「どうしてそんなことするの」\n\n……恋愛のもつれか？\nそれとも、もっと深い何か？' },
        {
          type: 'evidence',
          id: 'tanaka_mystery_woman',
          name: '田中と謎の女性との連絡',
          description: '田中のSNSのDMに残された謎の女性との親密なやり取り。感情的なメッセージが含まれている。',
        },
