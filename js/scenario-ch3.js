...
const Chapter3 = {
  scenes: {
    ...
    ch3_scene2: {
      ...
      bg: 'bg-office-dark',
      content: [
        { type: 'flag', key: 'met_nakamura', value: true },
    ...
    ch3_scene3: {
      ...
      content: [
        ...
        { type: 'narration', text: '送信元デバイス: 「TY-OLD-PHONE」\n送信時刻パターン: 毎回ちょうど正時\n最初の送信: 田中が殺された翌日\n\n「TY」……田中洋介のイニシャルか？' },
        {
          ...
          answer: ['田中の旧スマホ', '田中のスマホ', '田中の古いスマホ', 'たなかのスマホ', '田中のきゅうスマホ', 'たなかのきゅうスマホ', '田中の旧すまほ', '田中のふるいスマホ', '田中のスマートフォン', 'たなかの旧スマホ', '旧スマホ', 'きゅうスマホ', '田中の携帯', 'たなかのけいたい', '田中のきゅうけいたい', '田中の旧携帯', '田中の古い携帯', '田中の旧電話', '田中の古いスマートフォン', 'たなかのふるいけいたい', 'TY-OLD-PHONE'],
          hints: [
            'TY＝Tanaka Yosuke（田中洋介）。OLD＝旧い。PHONE＝スマホ。つまり「田中の旧○○」',
            '田中が生前にセットした自動送信システムでは？',
            '答えの例: 「○○の旧スマホ」「○○の旧携帯」',
          ],
          wrongMessage: '「誰の」「何のデバイスか」を日本語で答えよう\n例: 「○○の○○」',
