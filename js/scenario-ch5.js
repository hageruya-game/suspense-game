    ...
    ch5_scene2: {
      ...
      content: [
        ...
        { type: 'text', speaker: '{name}', text: '田中……お前は最後まで\n戦っていたんだな……。' },
        {
          ...
          name: '田中のデッドマンスイッチ',
          description: '田中が生前に作成した自動メッセージシステム。24時間以内にチェックインしないと自動的に警告メッセージを毎日送信。メッセージ内容は事前にプログラム済み。',
        },
    ...
    ch5_scene4: {
      ...
      content: [
        { type: 'narration', text: '自宅に戻ると、山本からメッセージが来ていた。' },
        {
          ...
          appName: '山本とのトーク',
          messages: [
            { from: 'other', text: '{name}、大事な話がある', time: '21:30', senderName: '山本' },
